...
namespace VaccinaCare.UnitTest
{
    public class ChildServiceTest
    {
        ...
        public ChildServiceTest()
        {
            ...
            _childService = new ChildService(_loggerMock.Object, _unitOfWorkMock.Object, _claimsMock.Object, _suggestionService.Object, _notificationService.Object);
        }
        ...
        public async Task CreateChildAsync_Success()
        {
            ...
            _notificationService.Setup(n => n.PushNotificationWhenUserUseService(It.IsAny<Guid>(), It.IsAny<NotificationForUserDTO>())).ReturnsAsync(new Notification { Id = Guid.NewGuid(),
            ...
            _notificationService.Verify(n => n.PushNotificationWhenUserUseService(It.IsAny<Guid>(), It.IsAny<NotificationForUserDTO>()), Times.Once);
        }
    }
}
