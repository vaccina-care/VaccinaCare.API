        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForBloodType = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    AvoidChronic = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvoidAllergy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DrugInteraction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpecialWarn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
