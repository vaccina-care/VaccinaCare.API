...
{
    [DefaultValue("trangiaphuc362003181@gmail.com")] public string Email { get; set; } = "a@gmail.com";

    [DefaultValue("Anonymous User")] public string FullName { get; set; } = "Anonymous User";

    [DefaultValue("1@")] public string Password { get; set; } = "1@"; // Mặc định đặt mật khẩu

    [DefaultValue("0909090909")] public string? PhoneNumber { get; set; } = "0909090909";

    [DefaultValue(true)] public bool? Gender { get; set; } = true; // Mặc định là Nam
